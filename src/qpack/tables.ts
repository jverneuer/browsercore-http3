 ...
 *
 * The predefined field lines, 0-indexed (RFC 9204 §3.1). Index 0 is
 * ":authority" with an empty value. Values are stored verbatim — an empty
 * string where the RFC shows a blank cell.
 *
 * QPACK's static table is indexed from 0, unlike HPACK's (which is 1-indexed).
 */

import type { HeaderField } from "../types.js";

/** The QPACK static table (RFC 9204 Appendix A). 0-indexed; 99 entries. */
