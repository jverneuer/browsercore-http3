 ...
 * implementation always encodes with H=0 (raw bytes) and decodes H=0 literals.
 */
 ...
 * the value, OR'd onto tag bits already placed in the high bits.
 */
 ...
 * the length; the high bit of those `n` bits is the Huffman flag.
 */
